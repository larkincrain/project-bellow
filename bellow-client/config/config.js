...
(function () {
    ...
    //API paths
    var apiPaths = {
        apiUrl: "http://52.10.189.70/api",												        //This needs to be the location of my node server
        test_apiUrl: "http://52.10.189.70/api/test",										//This needs to be the location of my node server test end point
    };
